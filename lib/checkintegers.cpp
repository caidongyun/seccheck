...
void CheckIntegers::checkBaseClass()
{
	const SymbolDatabase *symbolDatabase = _tokenizer->getSymbolDatabase();
...
void CheckIntegers::checkDeleteThis()
{
	const SymbolDatabase *symbolDatabase = _tokenizer->getSymbolDatabase();
...
void CheckIntegers::checkDeleteThisInFunction(const Function *func)
{
...
void CheckIntegers::checkIntegerRange()
{
}

void CheckIntegers::checkUsingStrtol()
{
