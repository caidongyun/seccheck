...
namespace {
    CheckSizeOfPointer instance;
}

void CheckSizeOfPointer::floatEqualsError(const Token *tok)
{
...
void CheckSizeOfPointer::findSizeofPointer()
{
	// TODO
