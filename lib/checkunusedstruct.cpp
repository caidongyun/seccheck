...
void CheckUnusedStruct::checkBaseClass()
{
	const SymbolDatabase *symbolDatabase = _tokenizer->getSymbolDatabase();
...
void CheckUnusedStruct::checkDeleteThis()
{
	const SymbolDatabase *symbolDatabase = _tokenizer->getSymbolDatabase();
...
void CheckUnusedStruct::checkDeleteThisInFunction(const Function *func)
{
